            ...
            <div className="flex flex-wrap">
                <div className="w-full px-6 pb-5">
                    <div className="relative w-full">
                        ...
                        <input id="url" className="w-full text-gray-600 dark:text-gray-400 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 bg-white font-normal h-10 flex items-center pl-16 text-base border-gray-300 rounded border shadow" placeholder="https://github.com/silentsoft/hits" value={url} onChange={handleUrlChange} />
                    </div>
                </div>
